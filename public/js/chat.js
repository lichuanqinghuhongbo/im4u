...
$(document).ready(function() {
    function e() {
        function h() { - 1 != g.indexOf("*#emo_") && (g = g.replace("*#", "<img src='default/faces").replace("#*", ".gif'/>"), h())
        }
        var e = new Date,
        f = "";
        f += e.getFullYear() + "-",
    ...
    var a = 3,
    b = "default/head/2024.jpg",
    c = "default/head/2015.jpg",
    d = "\u738b\u65ed";
    ...
    $(".wl_faces_main img").click(function() {
        var a = $(this).attr("src");
        $("#textarea").val($("#textarea").val() + "*#" + a.substr(a.indexOf("default/faces") + 4, 6) + "#*"),
        $("#textarea").focusEnd(),
        $(".wl_faces_box").hide()
    }),
